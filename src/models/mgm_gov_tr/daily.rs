...
pub struct DailyStat {
  ...
  pub hadise_gun1: Hadise,
  pub hadise_gun2: Hadise,
  pub hadise_gun3: Hadise,
  pub hadise_gun4: Hadise,
  pub hadise_gun5: Hadise,
  pub ist_no: i64,
...
impl ToDailyForecast<Hadise> for DailyStat {
  fn to_daily_forecast(&self) -> Vec<DailyForecast<Hadise>> {
    vec![
      DailyForecast {
        weather: self.hadise_gun1.clone(),
      ...
      DailyForecast {
        weather: self.hadise_gun2.clone(),
      ...
      DailyForecast {
        weather: self.hadise_gun3.clone(),
      ...
      DailyForecast {
        weather: self.hadise_gun4.clone(),
      ...
      DailyForecast {
        weather: self.hadise_gun5.clone(),
